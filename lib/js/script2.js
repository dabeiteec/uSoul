...
// function choiceColorImg(){
//     const blueImg = document.getElementsByClassName('button_blue_img')
//     const pinkImg = document.getElementsByClassName('button_pink_img')
    
//     const choiceImgBlue = document.querySelector('#film_blue')
//     const choiceImgPink = document.querySelector('#film_pink')

//     blueImg.addEventListener('click', () => choiceImgBlue.classList.remove('hidden'));
//     pinkImg.addEventListener('click', (event) => event.stopPropagation());
//     blueImg.addEventListener('click', () => choiceImgPink.classList.add('hidden'));

//     pinkImg.addEventListener('click', () => choiceImgPink.classList.remove('hidden'));
//     blueImg.addEventListener('click', (event) => event.stopPropagation());
//     pinkImg.addEventListener('click', () => choiceImgBlue.classList.add('hidden'));
// }
...
function buttonForSwithColor(){
    ...
    // const choiceImgBlue =[document.querySelector('#film_blue'),document.querySelector('#series_blue'),document.querySelector('#film_blue')]
